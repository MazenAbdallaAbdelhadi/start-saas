...
export async function InviteMemberView({ token }: InviteViewProps) {
...
function InviteSkeleton() {
  return (
    <div className="w-md h-85 bg-card rounded-xl border-2 flex flex-col p-8 items-center gap-6 animate-pulse">
