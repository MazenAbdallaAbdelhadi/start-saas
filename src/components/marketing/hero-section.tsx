...
import { SpotifyIcon } from "@/components/ui/svgs/spotify";
import { SupabaseIcon } from "@/components/ui/svgs/supabase";
import { VercelIcon } from "@/components/ui/svgs/vercel";
import { FirebaseIcon } from "@/components/ui/svgs/firebase";
import { FigmaIcon } from "@/components/ui/svgs/figma";
import { ClaudeIcon } from "@/components/ui/svgs/claude";
        ...
        <section className="dark:bg-background bg-muted/50 relative z-10 py-16">
          <div className="m-auto max-w-5xl px-6">
            ...
            <div className="**:fill-foreground mx-auto mt-20 flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12">
              <VercelIcon height={22} width={84} />
              <SupabaseIcon className="h-6" />
              <SpotifyIcon height={24} width={80} />
              <FirebaseIcon height={24} width={80} />
              <ClaudeIcon height={26} width={90} />
              <FigmaIcon height={24} width={24} />
            </div>
          </div>
        </section>
      </main>
